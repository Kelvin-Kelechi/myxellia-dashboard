    ...
    <div className="bg-white rounded-[16px] border border-gray-200 overflow-hidden">
      ...
      <div className="px-3 py-10 flex justify-between text-center">
        ...
        <div>
          ...
          <span className="block text-[20px] font-bold text-gray-900">80</span>
        </div>

        <div>
          <span className="block text-xs text-gray-500">Archived</span>
          <span className="block text-[20px] font-bold text-gray-900">1k</span>
        </div>
      </div>
    </div>
  );
