...
import { NewSalesChart } from "../charts/NewSalesChart";
...
export const SalesOverview: React.FC = () => {
  ...
  const charts = [<NewSalesChart key="new" />, <SalesChart key="old" />];
  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
      ...
      <div className="flex gap-6">
        <div className="flex-1 flex items-center rounded-xl p-4 relative min-w-[0]">
          <button
            className="absolute left-2 top-1/2 -translate-y-1/2 bg-white border border-gray-200 rounded-full p-1 shadow hover:bg-gray-50 transition"
            onClick={prevChart}
          >
          ...
          <button
            className="absolute right-2 top-1/2 -translate-y-1/2 bg-white border border-gray-200 rounded-full p-1 shadow hover:bg-gray-50 transition"
            onClick={nextChart}
          >
